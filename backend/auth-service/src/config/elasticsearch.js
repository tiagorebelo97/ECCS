/**
 * ============================================================================
 * Elasticsearch Client Configuration - Auth Service
 * ============================================================================
 *
 * Centralized Elasticsearch client configuration for the auth service.
 ...
 * await indexLog('info', 'User logged in', { userId: '456' });
 */
