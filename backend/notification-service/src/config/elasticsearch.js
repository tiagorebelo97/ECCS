/**
 * ============================================================================
 * Elasticsearch Client Configuration - Notification Service
 * ============================================================================
 *
 * Centralized Elasticsearch client configuration for the notification service.
 ...
 * await indexLog('info', 'Email delivered', { emailId: '123', latencyMs: 150 });
 */
